...
if __name__ == "__main__":
    ...
    # dataset_name = 'mcfarland_2020'
    # dataset_short_name = 'mcfarland'

    dataset_name = 'zhaoSims2021'
    dataset_short_name = 'zhaoSims'


    h5ad_path = f'./{dataset_name}_pre.h5ad'
    output_path = f'{dataset_short_name}_rdkit_emb_skip.parquet'
    smiles_key = 'SMILES'
